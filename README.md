...
## Привет！ 👋
Меня зовут Ольга и я - QA Engineer.

Занимаюсь обеспечением качества веб- и мобильных приложений. Мне нравится исследовать продукт, вести раскопки, искать скрытые проблемы, "ломать" и "строить" гипотезы. Моя цель — не просто найти баг, а сделать продукт интуитивно понятным, надёжным и удобным для пользователя.

Мои сильные стороны:
- Внимание к деталям (ловлю баги даже в баг-репортах).
- Умение чётко формулировать проблемы письменно и устно.
- Эмпатия к пользователю и уважение к команде.
- Настойчивость, но без раздражения.
- Самообучаемость — каждый день читаю, смотрю, ищу, пробую новое.

Ищу команду, где ценят качество, потому что качество — это не случайность, а результат осознанных и совместных усилий!

Открыта к сотрудничеству и новым проектам. Всегда рада конструктивной обратной связи.

Добро пожаловать в моё портфолио. Здесь собраны артефакты, которые показывают, как я мыслю, тестирую и документирую.



## 📊 Статистика

![](https://github-readme-stats.vercel.app/api?hide_rank=true&hide=issues,contribs&show_icons=true&locale=en&langs_count=6&card_width=320&username=Olga-Panchenko-qa
)
![](https://github-readme-stats.vercel.app/api/top-langs/?layout=donut&langs_count=6&hide_progress=true&username=Olga-Panchenko-qa
)

<!-- Выбор темы ↑↑: https://github.com/anuraghazra/github-readme-stats/blob/master/themes/README.md --> 
<!-- Настройка отображения ↑↑: https://github.com/anuraghazra/github-readme-stats/ --> 

![](https://github-readme-activity-graph.vercel.app/graph?&theme=chartreuse-dark&username=Olga-Panchenko-qa
)
...
[<img src="/Certificate2.png" width="280px" hspace="10px" alt="Certificate of Completion for the Basic Course in Quality Assurance Engineering">](https://github.com/Olga-Panchenko-qa/Olga-Panchenko-qa.github.io/blob/main/Certificate2.png)
[<img src="/Recommendation.png" width="280px" hspace="10px" alt="Рекомендательное письмо»">](https://raw.githubusercontent.com/Olga-Panchenko-qa/Olga-Panchenko-qa.github.io/refs/heads/main/Recommendation.png)
...
## 🤝 Контакт
[![Email](https://img.shields.io/badge/Email-3b5998?style=flat-square&logo=Mail.Ru&logoColor=white)](mailto:agloolga7@gmail.com)
[![Telegram Badge](https://img.shields.io/badge/-Telegram-0088cc?style=flat-square&logo=Telegram&logoColor=white)](https://t.me/YaOlgaP)
