...
📁 test-cases/ # примеры тест-кейсов (веб / мобилка / API)

📁 bug-reports/ # реальные или учебные баг-репорты

📁 checklists/ # чек-листы для smoke / регресса

📁 api-tests/ # Postman коллекции + окружения

📁 mind-maps/ # mind-карты по требованиям
